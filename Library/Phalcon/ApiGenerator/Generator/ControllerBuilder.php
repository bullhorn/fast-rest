...
use Phalcon\ApiGenerator\Api\Models\GeneratedInterface as Base;
use Phalcon\Mvc\Model\BehaviorInterface;
use Phalcon\ApiGenerator\Api\Services\Behavior\Upload\File as UploadableFile;
use Phalcon\ApiGenerator\Api\Services\Behavior\Upload\Base as UploadBehavior;
...
class ControllerBuilder {
	...
	private function getPutPostBodyDescriptionFiles($isCreating) {
		...
		foreach($behaviors as $behavior) {
			if(is_subclass_of($behavior, 'Phalcon\ApiGenerator\Api\Services\Behavior\Upload\Base')) {
	...
	private function build() {
		$this->getObject()->addUse('Phalcon\ApiGenerator\Api\Models\ApiInterface as ModelInterface');
