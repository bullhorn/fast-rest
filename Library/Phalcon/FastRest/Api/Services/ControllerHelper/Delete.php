...
use Phalcon\FastRest\Api\Models\ApiInterface;
use Phalcon\FastRest\Api\Services\Database\Transaction;
use Phalcon\Mvc\Model\Transaction\Failed as TransactionException;

/**
 * Class Delete
 * @package Phalcon\FastRest\Api\Services\ControllerHelper
 */
class Delete extends Base {
	 ...
	 *
	 * @param \Phalcon\FastRest\Api\Services\Acl\AclInterface $acl
	 *
