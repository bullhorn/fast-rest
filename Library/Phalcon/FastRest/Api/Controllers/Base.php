<?php
namespace Phalcon\FastRest\Api\Controllers;

use org\apache\maven\POM\_4_0_0\Model;
use Phalcon\FastRest\Api\Models\ControllerModelInterface as ModelInterface;
use Phalcon\FastRest\Api\Models\CreateObject;
use Phalcon\FastRest\Api\Services\ControllerHelper\Index;
use Phalcon\FastRest\Api\Services\ControllerHelper\Params;
use Phalcon\FastRest\Api\Services\ControllerHelper\Save;
use Phalcon\FastRest\Api\Services\ControllerHelper\Delete;
use Phalcon\FastRest\Api\Services\ControllerHelper\Show;
use Phalcon\FastRest\Api\Services\Acl\AclException;
use Phalcon\FastRest\Api\Services\ControllerHelper\ShowCriteria;
use Phalcon\Http\Request\Exception;
use Phalcon\Mvc\Controller;
use Phalcon\DI;
use Phalcon\Mvc\Model\Resultset\Simple as ResultSet;
use Phalcon\FastRest\Api\Services\Behavior\ValidationException;
use Phalcon\FastRest\Api\Services\Output\OutputInterface;
use Phalcon\FastRest\Api\Services\Acl\AclInterface;
use Phalcon\FastRest\Api\Services\DataTransform\Base as DataTransformer;
...
abstract class Base extends Controller {
	 ...
	 * @return \Phalcon\FastRest\Api\Models\CreateObject[]
	 */
	...
	public function afterExecuteRoute() {
		/** @var \Phalcon\FastRest\Api\Services\Output\OutputInterface $output */
