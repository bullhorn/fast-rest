<?php
namespace Phalcon\FastRest\Generator;
use Phalcon\FastRest\DbCompare\Table;
use Phalcon\FastRest\Generator\Database\Field;
use Phalcon\FastRest\Generator\Database\Index;
use Phalcon\FastRest\Generator\Database\Relationship;
...
class ModelBuilder {
	...
	public function buildFieldsTypes() {
		$this->getAbstractClass()->addUse('Phalcon\FastRest\Api\Models\ApiInterface');
	...
	private function buildValidation() {
		...
		$validation->addUse('Phalcon\FastRest\DependencyInjection');
		$validation->addUse('Phalcon\DI\InjectionAwareInterface');
		$validation->addUse('Phalcon\FastRest\Api\Services\Behavior\ValidationException');
		$validation->addUse('Phalcon\Mvc\Model\Message');
		$validation->addUse('Phalcon\Mvc\Model\ValidatorInterface');
		$validation->addUse('Phalcon\FastRest\Api\Services\Acl\Events as AclEvents');
		$validation->addUse('Phalcon\FastRest\Api\Services\ControllerHelper\Save as SaveService');
		$validation->addUse('Phalcon\FastRest\Api\Services\ControllerHelper\Delete as DeleteService');
...
';
		...
		foreach($this->getIndexes() as $index) {
			if($index->isUnique() && !$index->isPrimary()) {
				$validation->addUse('Phalcon\FastRest\Api\Services\Validator\Unique as ValidateUnique');
				$fields = array();
...
';
		...
		$content .= '		}';
		$this->getAbstractClass()->addUse('Phalcon\FastRest\Api\Services\Database\CriteriaHelper');
		$method = new Object\Method();
		$method->setAccess('public');
	...
	private function build() {
		...
		$this->getAbstractClass()->addUse('Phalcon\FastRest\Api\Models\GeneratedInterface');
	...
	private function initTestClass() {
		...
		$this->getTestClass()->addUse('Phalcon\FastRest\DependencyInjection');
