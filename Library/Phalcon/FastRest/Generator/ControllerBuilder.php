...
use Phalcon\FastRest\Api\Models\GeneratedInterface as Base;
use Phalcon\Mvc\Model\BehaviorInterface;
use Phalcon\FastRest\Api\Services\Behavior\Upload\File as UploadableFile;
use Phalcon\FastRest\Api\Services\Behavior\Upload\Base as UploadBehavior;
...
class ControllerBuilder {
	...
	private function getPutPostBodyDescriptionFiles($isCreating) {
		...
		foreach($behaviors as $behavior) {
			if(is_subclass_of($behavior, 'Phalcon\FastRest\Api\Services\Behavior\Upload\Base')) {
	...
	private function build() {
		$this->getObject()->addUse('Phalcon\FastRest\Api\Models\ApiInterface as ModelInterface');
