...
';
                    break;
                case 'Date':
                    $content .= '		if(!is_null($' . $field->getShortName() . ') && (!is_string($' . $field->getShortName() . ') || !preg_match(\'@^[0-9]{4}\-[0-9]{2}\-[0-9]{2}$@\', $' . $field->getShortName() . '))) {
...
';
                    break;
                case 'DateTime':
                    $content .= '		if(!is_null($' . $field->getShortName() . ') && (!is_string($' . $field->getShortName() . ') || !preg_match(\'@^[0-9]{4}\-[0-9]{2}\-[0-9]{2} [0-9]{2}:[0-9]{2}:[0-9]{2}$@\', $' . $field->getShortName() . '))) {
			$date = new ' . $field->getType() . '($' . $field->getShortName() . ');
			$' . $field->getShortName() . ' = $date->__toString();
		}
';
